...
Route::domain(config('app.admin_domain', 'panel.simpel-bjb.id'))->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Export rekapitulasi surat (semua role dashboard executive)
        Route::get('/dashboard/export-rekapitulasi', [DashboardController::class, 'exportRekapitulasi'])
            ->name('dashboard.export-rekapitulasi')
            ->middleware(['role:super_admin|admin_kabupaten|admin_kecamatan|admin_kelurahan']);
        ...
        Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
            ...
            Route::get('permohonan-surat/{permohonanSurat}/dokumen/{dokumen}/preview', [App\Http\Controllers\Admin\Surat\PermohonanSuratController::class, 'previewDokumen'])->name('permohonan-surat.preview-dokumen');
            ...
            Route::post('permohonan-surat/{permohonanSurat}/retry-ocr', [App\Http\Controllers\Admin\Surat\PermohonanSuratController::class, 'retryOcrVerification'])->name('permohonan-surat.retry-ocr');
