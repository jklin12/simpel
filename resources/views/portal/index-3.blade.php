    ...
    <div class="w-full lg:w-1/2 bg-gradient-to-br from-teal-600 to-cyan-700 flex items-center px-8 sm:px-12 lg:px-16 py-20 relative">
        ...
        <div class="relative z-10 max-w-lg">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('portal.berita') }}" class="px-7 py-4 bg-white/15 text-white font-semibold rounded-2xl border border-white/30 hover:bg-white/25 transition-all hover:-translate-y-0.5 transform text-center text-sm">
                    Baca Berita →
                </a>
            </div>
        </div>
...
<section class="bg-white border-y border-gray-100 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap gap-3 justify-center sm:justify-start">
            <a href="{{ route('home') }}#buat-surat" class="flex items-center gap-2 bg-teal-50 border border-teal-200 text-teal-700 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-teal-600 hover:text-white hover:border-teal-600 transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Ajukan Surat
            </a>
            <a href="{{ route('tracking.index') }}" class="flex items-center gap-2 bg-emerald-50 border border-emerald-200 text-emerald-700 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-emerald-600 hover:text-white hover:border-emerald-600 transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                </svg>
                Cek Status Surat
            </a>
            <a href="{{ route('portal.peta') }}" class="flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-600 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                </svg>
                Peta Wilayah
            </a>
            <a href="{{ route('portal.berita') }}" class="flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-600 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                </svg>
                Baca Berita
            </a>
            <a href="{{ route('portal.struktur-organisasi') }}" class="flex items-center gap-2 bg-purple-50 border border-purple-200 text-purple-600 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<section class="py-20" style="background: linear-gradient(180deg, #f0fdfa 0%, #ffffff 100%);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between mb-10">
            ...
            <a href="{{ route('portal.berita') }}" class="text-teal-600 font-medium hover:text-teal-700 flex items-center gap-1 text-sm">
                Lihat Semua →
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('portal.berita.detail', $berita->slug) }}" class="group block bg-white border border-gray-100 rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
