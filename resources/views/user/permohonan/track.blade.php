        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-primary-50 p-6 border-b border-primary-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="text-right">
                    ...
                    @if(($permohonan->revision_count ?? 0) > 0)
            ...
            {{-- Tombol Revisi (hanya jika status rejected) --}}
            ...
            <div class="p-6 bg-red-50 border-t border-red-100">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-red-900 text-sm">Permohonan Ditolak</p>
                            @if($permohonan->rejected_reason)
                            <p class="text-xs text-red-700 mt-0.5 leading-relaxed">{{ $permohonan->rejected_reason }}</p>
                            @endif
                            <p class="text-xs text-red-600 mt-1">Anda dapat memperbaiki dan mengajukan ulang permohonan ini.</p>
                        </div>
                    </div>
                    <a href="{{ route('layanan.surat.revisi', $permohonan->track_token) }}"
                        class="inline-flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm flex-shrink-0">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
