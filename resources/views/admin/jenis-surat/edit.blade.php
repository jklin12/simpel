    ...
    <form action="{{ route('admin.jenis-surat.update', $jenisSurat->id) }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center">
                <input type="checkbox" value="1" name="is_active" id="is_active" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" {{ old('is_active', $jenisSurat->is_active) ? 'checked' : '' }}>
