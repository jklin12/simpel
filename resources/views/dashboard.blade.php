...
@section('content')
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden group">
            <div class="relative z-10">
                ...
                <div class="mt-2 flex items-center text-xs text-green-600 font-medium">
                    <span class="bg-green-50 px-1.5 py-0.5 rounded mr-1">
                        +12%
                    </span>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden group">
            <div class="relative z-10">
                ...
                <div class="mt-2 flex items-center text-xs text-orange-600 font-medium">
                    <span class="bg-orange-50 px-1.5 py-0.5 rounded mr-1">
                        Urgent
                    </span>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden group">
            <div class="relative z-10">
                ...
                <div class="mt-2 flex items-center text-xs text-blue-600 font-medium">
                    <span class="bg-blue-50 px-1.5 py-0.5 rounded mr-1">
                        +5%
                    </span>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="overflow-x-auto">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-800 text-sm">Budi Santoso</p>
                                    <p class="text-xs text-gray-400">3301xxxxxxxx</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-600">Surat Keterangan Domisili</td>
                        <td class="px-6 py-4 text-sm text-gray-500">01 Feb 2026</td>
                        <td class="px-6 py-4">
                            <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-700 border border-orange-100">Pending</span>
                        </td>
            ...
            <!-- Empty State (Hidden) -->
            <div class="p-8 text-center text-gray-500 hidden">
                ...
                <p>Belum ada permohonan surat hari ini.</p>
            </div>
        </div>
    </div>
@endsection
